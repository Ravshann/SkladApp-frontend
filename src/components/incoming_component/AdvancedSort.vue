...
div
  ...
  v-btn(color='#967ADC' dark='' @click='advanced_sort_dialog = true') &Scy;&ocy;&rcy;&tcy;&icy;&rcy;&ocy;&vcy;&acy;&tcy;&softcy;
  // dialog for 'outgoing' button
  v-dialog(v-model='advanced_sort_dialog' max-width='500px' scrollable='')
    v-card
      v-card-title &Scy;&ocy;&rcy;&tcy;&icy;&rcy;&ocy;&vcy;&acy;&tcy;&softcy; &pcy;&ocy;
      v-card-text
      ...
      v-card-actions
        v-btn(color='primary' flat='' @click='close') &Zcy;&Acy;&Kcy;&Rcy;&Ycy;&Tcy;&SOFTcy;
        v-btn(color='primary' @click='close') &Scy;&Ocy;&Rcy;&Tcy;&Icy;&Rcy;&Ocy;&Vcy;&Acy;&Tcy;&SOFTcy;
