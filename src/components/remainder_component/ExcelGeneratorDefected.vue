...
export default {
  ...
  computed: {
    ...mapGetters({
      remainder_data: "remainders/get_defected_remainder_data",
      data_is_sorted: "remainders/get_defected_sorted_flag",
      remainder_data_sorted: "remainders/get_defected_sorted_data",
  ...
  methods: {
    ...
    createAndFillWorkbook(simplified) {
      ...
      //worksheet name
      const ws = wb.addWorksheet("брак остаток");
