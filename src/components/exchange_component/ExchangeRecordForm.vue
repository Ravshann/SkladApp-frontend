...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      exchange_data: "exchange/get_data",
  ...
  methods: {
    ...
    async refresh() {
      ...
      //   if (this.storages[0].storage_type === "Exchange")
      //     this.getExchangeDataByStorage(this.storages[0].storage_ID);
      //   else this.getExchangeDataBySupplierStorage(this.storages[0].storage_ID);
